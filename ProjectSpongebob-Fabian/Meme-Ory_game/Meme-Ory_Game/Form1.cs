...
namespace Meme_Ory_Game
{
    public partial class Form1 : Form
    {
        ...
        Label singleplayerRules = new Label();
        Label multiplayerRules = new Label();
        ...
        public Form1()
        {
            ...
            CreateGameTitle();
            CreateRulesLabel();
            CreateSecondRulesButton();

            goback.Visible = false;
            Rules.Visible = false;
            secondRules.Visible = false;
        }
        ...
        public void CreateGoBackButton()
        {
            ...
            var Roze = System.Drawing.Color.FromArgb(199, 21, 133);
            var Wit = System.Drawing.Color.FromArgb(255, 255, 255);
            goback.Location = new Point(15, 650);
        ...
        public void GoBackbutton_Click(object sender, EventArgs e)
        {
            ...
            Save.Visible = false;
            PlayerNameLabel_1.Visible = false;
            PlayerNameLabel_2.Visible = false;
        ...
        public void SecondrulesButton_Click(object sender, EventArgs e)
        {
            ...
            if (Gamemode.Text == "Singleplayer")
            {
                CreateSingleplayerRulesLabel();
                multiplayerRules.Visible = false;
            }
            else
            {
                CreateMultiplayerRulesLabel();
                singleplayerRules.Visible = false;
            }
        }

        public void CreateSingleplayerRulesLabel()
        {
            this.Controls.Add(singleplayerRules);
            var Roze = System.Drawing.Color.FromArgb(199, 21, 133);
            singleplayerRules.Size = new Size(1016, 759);
            singleplayerRules.Location = new Point(800, 40);
            singleplayerRules.Font = new Font("Lucida Sans", 8);
            singleplayerRules.ForeColor = Roze;
            singleplayerRules.Text = "Je hebt voor Singleplayer gekozen.\n\nDoel\nHet doel van het singleplayer spel\nis om binnen de tijd, zoveel mogelijk\nparen van kaartjes te maken.\nHoe sneller je bent, \nhoe hoger je score.\n\nRegels\nOm een zo hoog mogelijke \nscore te behalen, \nmoet je zo snel mogelijk paren \nmaken van alle kaarten.";
        }

        public void CreateMultiplayerRulesLabel()
        {
            this.Controls.Add(multiplayerRules);
            var Roze = System.Drawing.Color.FromArgb(199, 21, 133);
            multiplayerRules.Size = new Size(1016, 759);
            multiplayerRules.Location = new Point(800, 40);
            multiplayerRules.Font = new Font("Lucida Sans", 8);
            multiplayerRules.ForeColor = Roze;
            multiplayerRules.Text = "Jullie hebben voor Multiplayer \ngekozen.\n\nDoel\nHet doel van het multiplayer spel \nis om meer paartjes te maken\ndan je tegenstander.\nDegene met de meeste paartjes, \nwint het spel.\n\nRegels\nOm een zo hoog mogelijke score te behalen, \nmoet je meer paartjes maken \ndan je tegenstander.\nVoor het laatste paartje krijg je geen punten, \nop deze manier is er altijd een winnaar.";
        }
